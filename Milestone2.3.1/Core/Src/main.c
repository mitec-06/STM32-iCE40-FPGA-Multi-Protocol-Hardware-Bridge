...
// enable I2C
  ...
  while (1)
  {
    ...
    volatile uint8_t shifted = (0x48 << 1) | 0x01;
  ...
  if (LL_I2C_IsActiveFlag_AF(I2C1)){
      ...
      */
      ...
      uint8_t high_byte = LL_I2C_ReceiveData8(I2C1);

      while(!LL_I2C_IsActiveFlag_RXNE(I2C1)){}

      LL_I2C_GenerateStopCondition(I2C1);

      uint8_t low_byte = LL_I2C_ReceiveData8(I2C1);
      // while(!LL_I2C_IsActiveFlag_STOP(I2C1));
      ...
      uint16_t data = raw_data >> 4;

      float temperature = data * 0.0625f;
